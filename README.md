...
The Sphere-Packing project is a live demo showcasing a dynamic sphere packing visualization in a web browser. This project utilizes the Three.js library (via a CDN) to render a background of animated spheres. Users can interact with the visualization by toggling the animation on/off and randomizing the colors of the spheres and the light source.
...
├── script.js          # JavaScript file for sphere packing logic
...
*   **Live Demo:** [https://sphere-packing.netlify.app/](https://sphere-packing.netlify.app/)

## Footer 👣


**Sphere-Packing** - [https://github.com/theunstopabble/Sphere-Packing](https://github.com/theunstopabble/Sphere-Packing) 

Author: [theunstopabble](https://github.com/theunstopabble)

Contact: N/A

⭐️ Like this project? Give it a star on [GitHub](https://github.com/theunstopabble/Sphere-Packing)!

🍴 Fork this repository to contribute and make it even better!

🐛 Found a bug or have a feature request? Open an [issue](https://github.com/theunstopabble/Sphere-Packing/issues).
